...
def train(mnist):
    x = tf.placeholder(tf.float32, [BATCH_SIZE, cnn.cnn_mnist_inference.IMAGE_SIZE, cnn.cnn_mnist_inference.IMAGE_SIZE,
    ...
    with tf.Session() as sess:
        ...
        for i in range(TRAINING_STEPS):
            ...
            reshaped_xs = np.reshape(xs, (
                BATCH_SIZE, cnn.cnn_mnist_inference.IMAGE_SIZE, cnn.cnn_mnist_inference.IMAGE_SIZE,
